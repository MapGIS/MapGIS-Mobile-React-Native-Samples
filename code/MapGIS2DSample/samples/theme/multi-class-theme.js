...
//     let environment = await Environment.createInstance();
...
//     // 创建多表达式分段对象
//     let multiClassTheme = await MultiClassTheme.createInstance();
...
//     // 分段1
//     // 创建分段值对象
//     let classItemValue1 = await ClassItemValue.createInstance();
...
//     // 分段2
//     let classItemValue2 = await ClassItemValue.createInstance();
...
//     // 分段3
//     let classItemValue3 = await ClassItemValue.createInstance();
...
//     // 分段4
//     let classItemValue4 = await ClassItemValue.createInstance();
