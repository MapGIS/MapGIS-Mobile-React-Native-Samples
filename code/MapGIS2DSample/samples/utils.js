...
export const DB_CREATE_FILE_PATH =
  INITIALIZE_PATH + '/Map/MapShow/RNCreateDb0927/RNTest0927.mgdb';

export const DB_UPDATE_FILE_PATH =
 ...
 * （2）瓦片地图文档
 */
export const TILE_FILE_PATH = INITIALIZE_PATH + '/Map/MapShow/hubei.mut';
export const TILE_MAPX_PATH = INITIALIZE_PATH + '/Map/MapShow/HuBei.mapx';
...
export const SERVER_DOC_MAPX_PATH =
  INITIALIZE_PATH + '/Map/MapShow/OnlineBeiJingJWVector.mapx';
...
export const SERVER_TILE_MAPX_PATH =
  INITIALIZE_PATH + '/Map/MapShow/OnlineBeiJingJWTile.mapx';
...
export const BUIDING_FILE_PATH =
  INITIALIZE_PATH + '/Map/MapShow/Buildings/buildings_new.mapx';
