 ...
 */
export default class DisplayAMapMap extends Component {
  static navigationOptions = { title: '高德地图' };
  ...
  showMap = async () => {
    ...
    let mapServer = await ImageLayer.createMapServer(
      // MapServer.MapServerType.MAPSERVER_TYPE_AMAP_MERCATOR_EMAP,
      'AMapMercatorEMap',
    );
    await mapServer.setName('AMap');
