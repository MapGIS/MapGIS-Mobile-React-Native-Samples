...
export default class Display3DViewMap extends Component {
  ...
  animationMapView = async () => {
    // 中心点
    let centerDot = await Dot.createInstance(
      12734840.911782857,
      3568731.256785354
    );

    // 旋转中心点
    let rotateCenterDot = await Dot.createInstance(
      12734947.334961485,
      3568606.05406966
    );

    let mapPosition = await MapPosition.createInstance(
      centerDot.ObjId,
      0.462913295,
      rotateCenterDot.ObjId,
      -19.78676,
      58.281357
    );
