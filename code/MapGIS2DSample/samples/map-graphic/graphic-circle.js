...
import { MGMapView, Dot, GraphicCircle } from '@mapgis/uniform-core-react-native';
...
export default class MapGraphicPoint extends Component {
  ...
  openMap = async () => {
    ...
    let dot = await Dot.createInstance(12729985, 3606886);

    this.graphicCircle = await GraphicCircle.createInstance();
