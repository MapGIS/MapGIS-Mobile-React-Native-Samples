...
export default class MapGraphicPolygon extends Component {
  ...
  openMap = async () => {
    ...
    var dotArray = [];
    var dot0 = await Dot.createInstance(12742678.48, 3620270.51);
    var dot1 = await Dot.createInstance(12754184.19, 3595188.06);
    var dot2 = await Dot.createInstance(12774664.36, 3611065.94);
    var dot3 = await Dot.createInstance(12742678.48, 3620270.51);
    dotArray.push(dot0);
    dotArray.push(dot1);
    dotArray.push(dot2);
    dotArray.push(dot3);
